...
exports.FlyScriptCompletionProvider = void 0;
const vscode = __importStar(require("vscode"));
const FLY_SCRIPT_ITEMS = [
    // Directives
    {
        label: '"use server"',
    ...
    // Server Exports
    {
        ...
        insertText: new vscode.SnippetString("export async function loader({ request, params }) {\n  return { data: ${1:{}} };\n}"),
        sortPriority: "2",
    },
    {
        label: "meta",
        ...
        insertText: new vscode.SnippetString("export function meta({ data }) {\n  return { title: ${1:\"Page Title\"} };\n}"),
        sortPriority: "2",
    },
    {
        ...
        insertText: new vscode.SnippetString("export async function generateStaticParams() {\n  return [${1:{ id: \"1\" }}];\n}"),
        sortPriority: "2",
    },
    {
        label: "middleware",
        ...
        insertText: new vscode.SnippetString("export default async function middleware({ request, next }) {\n  ${1:// guard logic}\n  return next();\n}"),
        sortPriority: "2",
    },
    // API Handlers
    {
        ...
        insertText: new vscode.SnippetString("export async function GET({ request, params }) {\n  return Response.json(${1:{ ok: true }});\n}"),
        sortPriority: "3",
    },
    {
        label: "POST",
        ...
        insertText: new vscode.SnippetString("export async function POST({ request, params }) {\n  const body = await request.json();\n  return Response.json(${1:{ created: true, ...body }});\n}"),
        sortPriority: "3",
    },
    {
        label: "PUT",
        ...
        insertText: new vscode.SnippetString("export async function PUT({ request, params }) {\n  const body = await request.json();\n  return Response.json(${1:{ updated: true }});\n}"),
        sortPriority: "3",
    },
    {
        label: "PATCH",
        ...
        insertText: new vscode.SnippetString("export async function PATCH({ request, params }) {\n  const body = await request.json();\n  return Response.json(${1:{ patched: true }});\n}"),
        sortPriority: "3",
    },
    {
        label: "DELETE",
        ...
        insertText: new vscode.SnippetString("export async function DELETE({ request, params }) {\n  return Response.json(${1:{ deleted: true }});\n}"),
        sortPriority: "3",
    },
    // Config Exports
    {
    ...
    // Cache & Utils
    {
        ...
        insertText: new vscode.SnippetString('await cache.fetch("${1:key}", async () => {\n  ${2:// producer}\n}, { ttl: ${3:60}, tags: ["${4:tag}"] })'),
        sortPriority: "5",
    },
    {
...
class FlyScriptCompletionProvider {
    provideCompletionItems(document, position, _token, _context) {
        ...
        for (const varName of stateVars) {
            ...
            completionItem.documentation = new vscode.MarkdownString(`Reactive variable \`${varName}\`. Updates automatically in the template.\n\nAccess: \`{${varName}}\` in template, or \`{${varName}.property}\` for objects.`);
...
exports.FlyScriptCompletionProvider = FlyScriptCompletionProvider;
